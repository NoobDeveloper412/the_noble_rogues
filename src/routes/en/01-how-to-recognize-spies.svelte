    ...
    <ChapterItem class="mb-20 z-10">
      ...
      >
        <Card class="animate-slideInBlurredBottom">
          ...
          <p class="mt-6">
            The truth is spies often look nothing like spies. They tend to be <br
            />
            <IntersectionObserver
              element={elementForSpy}
              bind:intersecting={intersectingSpy}
            >
              <span class="tracking-3 uppercase" bind:this={elementForSpy}
