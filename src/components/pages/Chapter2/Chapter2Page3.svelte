...
<div class="chapter-item relative flex sm:flex-col kitch">
  ...
  <Card class="card">
    ...
    <p class="mt-8" bind:this={triggerPoint}>
      ...
      </Explanation> - that’s the name of this icebox. When the Kelvinator is
      connected to electricity, it’s difficult to talk in the kitchen, because
      its engine rumbles like a motorcycle, the box itself shakes and sways from
      side to side. Anyway, from now on Dad always has some cold beer, Mom buys
      half a kilo of butter and we kids get ice cream. To get ice cream, you no
      longer have to go to the ice cream parlor in the downtown, just think
      about it.
    </p>
  </Card>
</div>
