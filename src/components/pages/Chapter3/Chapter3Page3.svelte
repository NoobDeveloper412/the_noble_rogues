  ...
  <div slot="story">
    <Card class="mb-16">
      <p bind:this={triggerPoint}>
        ...
        spirteli prie namo rūkęs sekretoriusTwo little boys are playing in the
        yard, the older Hiroki throws the ball to the little Chiaki, who is just
        starting to walk, so the ball he didn’t catch is kicked by the secretary
        Gudze, smoking at the corner of the house.
        <Explanation
          variant="green"
          class="w-120 md:w-80"
      ...
      <p>
        ...
        <Explanation variant="green" class="w-120 md:w-80">
          ...
          >
        </Explanation>This must be for the sake of the cats, because when a
        cat waits at the door and the door opens inwards, you won’t hurt it even
        by accident.
      </p>
    </Card>
  </div>
