...
<div class="chapter-item container flow-root sm:flex">
  ...
  <Card class="card float-right sm:float-none">
    <p>
      ...
      and dinner required changing clothes. Live music: before the orchestra
      started playing, we had to sit at the table in fancy outfits. When someone
      later asked me, “How was it to be on a ship like that?" I replied, “I've
      been changing my outfits all the time.
    </p>
    <p class="mt-8">
